            ...
            <section class='background bg-image' style="background-image: url('/assets/images/photos/sep-strike-gs.jpg');">
                <div class='container splash'>
                    <div class='layout wide'>
                        <h1>We demand good jobs and a livable future.</h1>
                    </div>
                ...
                <div class='container'>
                    ...
                    <div class='layout wide pair'>
                        <div class='first-on-mobile'>
                            <p>The climate crisis is already happening right here in Rhode Island. Extreme weather events are growing more intense, shifting ocean conditions are affecting fishing stocks, and asthma rates from fossil fuel pollution are among the worst in the country. And across the board, it's indigenous people, people of color, and poor and working people who are bearing the brunt of the climate crisis.</p>
                            <p>The youth of Rhode Island have had enough. The climate crisis is happening now, but it's young people who will face its worst effects. Sunrise is striking to demand a Green New Deal for Rhode Island that will create thousands of good jobs and ensure a livable future for all.</p>
                        </div>
            ...
            <section class='background light'>
                <div class='container'>
                    ...
                    <div class='layout narrow'>
                        <h5 class='text-align-center'>Rhode Island deserves a governor who will face climate change head-on and show leadership by rejecting fossil fuel money, and we deserves a governor who isn't ashamed to look young people in the eye as we fight for a livable future. </h5>
                    </div>
                    <div class='layout narrow'>
                ...
                <div class='container'>
                    <div class='layout wide'>
                        <h2>We demand a Green New Deal.</h2>
                    </div>
                    <div class='layout wide pair'>
                        <div>
                            <p>We've had decades of politicians advocating for small, gradual change and trusting corporations to do the right thing. That hasn't worked.</p>
                    ...
                    <div class='layout wide'>
                        <div class="center-contents">
                            <a class='button yellow' href='https://www.sunrisemovement.org/green-new-deal' target='_blank'>About the Green New Deal</a>
                        </div>
                    </div>
                </div>
            </section>
